...
describe('ExercisesList', () => {
  describe('when exercises prop is empty', () => {
    const component = shallow(<Exercises exercises={[]} />);
  ...
  describe('when exercises prop is not empty', () => {
    const exercises = [
    ...
    it('renders a toggle switch when there are exercises', () => {
      const toggle = component.find(ToggleSwitch);
